...
public class Take3DScreenshot : ScriptableWizard
{
    ...
    public static string folder = "E:/ZhangYi/Unity2018.2.1Projects/Unity2018.2.1f1_Study/Assets/StreamingAssetsPath";
    ...
    void TakeScreenshot()
    {
        ...
        {
            ScreenCapture.CaptureScreenshot(folder + fileName + number + "_" + number.ToString("d4") + ".png");
